...
# Have it write to a file listing out the coordinates? That way it can look for the file
# if it doesn't exist then it automatically runs the setup procedure
